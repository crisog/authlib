...
class LitestarAppMixin(object):
    ...
    async def authorize_redirect(self, request, redirect_uri=None, **kwargs):
        ...
        :param request: HTTP request instance from Litestar view.
        :param redirect_uri: Callback or redirect URI for authorization.
        :param kwargs: Extra parameters to include.
        :return: A HTTP redirect response.
        """

        # Handle Litestar >= 0.26.0 where redirect_uri may now be a URL and not a string
...
class LitestarOAuth2App(LitestarAppMixin, AsyncOAuth2Mixin, AsyncOpenIDMixin, BaseApp):
